...
aspFile = InputBox("Enter ShortURL ID")&".asp" ' Change the path and filename as needed
...
file.WriteLine("Response.Redirect("&chr(34)&url&chr(34)&")") ' Change the URL as needed
file.WriteLine("%>")
file.Close
